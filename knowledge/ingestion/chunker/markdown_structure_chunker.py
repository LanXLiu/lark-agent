...
class MarkdownStructureChunker(BaseChunker):
    ...
    async def chunk(self, text: str, **kwargs) -> list[ChunkResult]:
        ...
        if not doc_type:
            from knowledge.ingestion.chunker.doc_type_detector import DocTypeDetector
    ...
    def _chunk_word(
        ...
        from knowledge.utils.markdown_hierarchy import extract_sections, iter_leaf_sections
    ...
    def _append_pipe_table_chunks(
        ...
        """
        from knowledge.ingestion.file_to_markdown.table_renderer import records_to_text, rows_to_records
