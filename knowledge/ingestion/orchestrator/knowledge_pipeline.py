...
from knowledge.ingestion.chunker import BaseChunker, ChunkerFactory, ChunkResult
...
def main() -> None:
    """
    命令行入口：``python -m knowledge.ingestion.orchestrator.knowledge_pipeline [flags]``。
