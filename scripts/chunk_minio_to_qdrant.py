...
用法：
  python -m scripts.chunk_minio_to_qdrant                      # 全部 chunk/
  python -m scripts.chunk_minio_to_qdrant --prefix chunk/knowledgebase/lark/oc_xxx/
  python -m scripts.chunk_minio_to_qdrant --collection knowledgebase
"""
