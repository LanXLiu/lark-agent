...
配置见 ``infrastructure/conf/config_local.yaml`` 的 ``MODELS.JobEmbed``：``url`` / ``api_key`` /
...
from infrastructure.model.schemas.model_response import BatchEmbeddingResult, EmbeddingResult, LLMUsage
