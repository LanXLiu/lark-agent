...
from app.assistant.prompts.agent import AGENT_SYSTEM_PROMPT, build_web_fallback_user, WEB_FALLBACK_SYSTEM_PROMPT
...
from app.assistant.memory import AnswerContext
from app.assistant.qa_service import NO_RECALL_REPLY, QaAnswer, _is_no_answer
from app.assistant.skills.business_database import business_database_skill_context
...
class AgentService:
    ...
    def _node_execute(self, state: AgentState) -> dict[str, Any]:
        ...
        ctx = state.get("tool_context") or ToolContext(
    ...
    def answer(
        ...
        *,
        ...
        skill_context = business_database_skill_context(question, tool_context)
        if skill_context:
