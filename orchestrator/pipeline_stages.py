...
命令行::
    ...
    python orchestrator/pipeline_stages.py                 # 全流程默认
    python orchestrator/pipeline_stages.py chunk_to_qdrant           # 仅向量化
    python orchestrator/pipeline_stages.py chunk_to_qdrant --force # 强制重跑（新编码覆盖）
"""
...
# Allow direct execution: python orchestrator/pipeline_stages.py ...
...
from orchestrator.chunk_to_qdrant import ChunkToQdrantStage
from orchestrator.markdown_to_chunk import MarkdownToChunkStage
from orchestrator.pipeline_common import PipelineStageContext, StageResult
from orchestrator.raw_to_markdown import RawToMarkdownStage
from utils.sparse_embedder import ensure_fastembed_installed
