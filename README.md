...
**带引用来源的结构化问答 + 👍/👎 反馈**：@机器人提问后先贴 OK 表情快速 ack，再回结构化 Markdown 答案，附来源与反馈卡片（下图正文为公司数据，已打码）。

![带来源的问答与反馈卡片](docs/screenshots/qa-with-sources.jpg)

**闲聊 / 非专业问题的自主处理**：无前置意图分类，LLM 自主判断——闲聊直接寒暄，问天气等超出知识库范围的问题坦诚说明能力边界、不硬答。

![闲聊与非专业问题处理](docs/screenshots/chitchat-handling.png)
